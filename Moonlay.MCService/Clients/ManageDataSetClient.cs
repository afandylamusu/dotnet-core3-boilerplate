...
namespace Moonlay.MasterData.OpenApi.Clients
{
    internal class ManageDataSetClient : MasterData.Protos.ManageDataSet.ManageDataSetClient, IManageDataSetClient
    {
        ...
        public override AsyncUnaryCall<AllDataSetsReply> AllDataSetsAsync(AllDataSetsReq request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default)
        {
            return base.AllDataSetsAsync(request, headers, deadline, cancellationToken);
        }
    }
    ...
    public interface IManageDataSetClient
    {
        ...
        AsyncUnaryCall<AllDataSetsReply> AllDataSetsAsync(AllDataSetsReq request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default);
    }
}
