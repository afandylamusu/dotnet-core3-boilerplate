...
{{- printf "Host=%s;Database=%s;Username=%s;Password=%s" (include "postgresql.fullname" .) .Values.app.dbName .Values.app.dbUser .Values.app.dbPassword -}}
{{- end -}}

{{- define "mdm-grpc-chart.trailConnectionString" -}}
{{- printf "Host=%s;Database=%s_trail;Username=%s;Password=%s" (include "postgresql.fullname" .) .Values.app.dbName .Values.app.dbUser .Values.app.dbPassword -}}
{{- end -}}